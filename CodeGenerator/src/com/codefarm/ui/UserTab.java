...
public class UserTab extends JPanel implements Observer {
	...
	private void addCodes() {
		if (_frontEnd.getUsers().size() == 0 || _frontEnd.getMyCodeSpaces().size() == 0) {
	...
	private void showViewUpdateCodeDataDialog() {
	...
	private void initialise() {
		...
		_btnAllocateCodes = new JButton("Add Code(s)");
	...
	public void update(Observable o, Object arg) {
		refreshUsersList();
		this._userCountTextField.setText(String.valueOf(_frontEnd.getUsers().size()));
	}
